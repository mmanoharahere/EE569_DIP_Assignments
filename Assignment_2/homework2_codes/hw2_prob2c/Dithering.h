...
#ifndef HW2_PROB2C_DITHERING_H
#define HW2_PROB2C_DITHERING_H
...
public:
    ...
    void order_dithering(Image* inputImage, Image* outputImage_4, Image* outputImage_8);
