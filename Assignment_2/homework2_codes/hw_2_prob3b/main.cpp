...
int main(int argc, char *argv[]) {
    ...
    if (argc != 6)	{	cout << "Syntax Error - Incorrect parameter usage" << endl;
        ...
        cout << "<program_name> <input_image>.raw  <ImgWidth> <ImgHeight> <BytesPerPixel> <Thinoutput.raw> " << endl;
        return 0;
    }
    ...
    if (imgOpen) {
       ...
       // shrink_3_img->print_image(argv[],*shrink_1_img);
