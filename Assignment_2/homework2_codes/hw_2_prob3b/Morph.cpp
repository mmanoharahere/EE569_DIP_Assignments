        ...
        for (int col = 0; col < reducedChannel->width; col++) {
            ...
            if(centerNormPixelValue == 1){
               ...
               /// choose the appropriate mask for the bond size and check if they match
                 ...
                 if(currentBond == 4){
                    int maskSize = 72;
                    isHit =  multiplymasks(t_bond4,searchPixels,searchPixelsSize,neighborhood, maskSize, currentBond);
                    ...
                    int maskSize = 72;
                    isHit =  multiplymasks(t_bond5,searchPixels,searchPixelsSize,neighborhood, maskSize, currentBond);
                    // reduceLayer(searchPixelsAddress,searchPixels,searchPixelsSize,outputChannel,isHit);
                    if(isHit){
                        outputChannel->data[currPixelLocation] = 255;
                    }
                    ...
                    int maskSize = 90;
                    isHit =  multiplymasks(t_bond6,searchPixels,searchPixelsSize,neighborhood, maskSize, currentBond);
                    ...
                    int maskSize = 36;
                    isHit =  multiplymasks(t_bond7,searchPixels,searchPixelsSize,neighborhood, maskSize, currentBond);
                    if(isHit){
                        outputChannel->data[currPixelLocation] = 255;
                    }
                    else{
                    ...
                    int maskSize = 36;
                    isHit =  multiplymasks(t_bond8,searchPixels,searchPixelsSize,neighborhood, maskSize, currentBond);
                    if(isHit){
                        outputChannel->data[currPixelLocation] = 255;
                    }
                    else{
                    ...
                    int maskSize = 72;
                    isHit =  multiplymasks(t_bond9,searchPixels,searchPixelsSize,neighborhood, maskSize, currentBond);
                    if(isHit){
                        outputChannel->data[currPixelLocation] = 255;
                    }
                    else{
                    ...
                    int maskSize = 36;
                    isHit =  multiplymasks(t_bond10,searchPixels,searchPixelsSize,neighborhood, maskSize, currentBond);
                    if(isHit){
                        outputChannel->data[currPixelLocation] = 255;
                    }
                    else{
            ...
            if(centerNormPixelValue == 0){
                ...
                if (searchPixels[0] == 0 && (searchPixels[1] || searchPixels[5] == 1) && searchPixels[2] == 1 &&
                    ...
                    hit++;
                       ...
                       (searchPixels[3] == 0 || searchPixels[7] == 1) && searchPixels[4] == 1 &&
